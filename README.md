...
TS Game Studio's permanent laboratory for game-jam prototypes, submissions, reusable Godot tooling, and postmortems.
...
Each event lives under `events/<year>-<jam>/` with its source, design notes, tests, and submission material. A push to `main` tests the active Godot project, exports the Web build, and publishes it to GitHub Pages.

## Current prototypes

| Game | Format | Core idea |
| --- | --- | --- |
