...
- The three original launcher/key-art images and the ZERO PERCENT CITY gameplay backdrop were created with OpenAI image generation from original prompts written for this project. PROJECT CHARGE combines procedural Godot effects with original PixelLab machinery, UI, mechanical beasts, and twelve PRIME CURRENT form candidates including three slender dark-king refinements; prompts, API settings, generations used, and selection notes are recorded locally.
