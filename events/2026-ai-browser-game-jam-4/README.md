...
- The itch.io marketing pass adds original OpenAI-generated high-resolution key art and a 63-second Godot-rendered trailer scored by a separate Suno instrumental. These marketing-only masters are preserved under [`submission/`](submission/) and do not alter the eighteen-track runtime soundtrack count.
