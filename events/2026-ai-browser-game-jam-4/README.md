...
- PROJECT CHARGE uses five original instrumental Suno generations selected by the user from A/B candidates. Exact song URLs, IDs, processing, and runtime assignments are recorded in [`docs/SUNO_MUSIC_BRIEF.md`](docs/SUNO_MUSIC_BRIEF.md).
